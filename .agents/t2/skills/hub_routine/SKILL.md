...
| 函数 | 说明 |
|------|------|
| `start_hub(routines=None, hub_id="hub_routine", kernel_addr=None, wait=2.0)` | 启动 hub,返回 passive 实例 |
| `stop_hub()` | 停止 hub |
...
- kernel 地址:环境变量 `ZERO_KERNEL_ADDR` 或 `start_hub(kernel_addr=...)`,默认 `127.0.0.1:8888`
